...
| :- | -: |
|Программист C++|*сен 2023 – Now*|

- Реализация алгоритмов контроля наземной станции коррекции спутникового сигнала GNSS аэропорта. Пройдены испытания и получен сертификат типа на устройство

- Оптимизация ПО имитации спутникового сигнала GNSS используя NVIDIA CUDA GPU ускоритель. Получено 10-кратное увеличение производительности

- Разработка ПО для аппаратуры сигнализации занятости ВПП. Система прошла сертификацию и успешно применяется

- Применяемые технологии: C++, C#, Python, CUDA



|**NIIIT-RK**|[http://niiit-rk.ru/](http://niiit-rk.ru/)|
| :- | -: |
|Программист C++|*окт 2022 – апр 2023*|
